        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            <div className="leading-tight">
              ...
              <div className="text-xs text-slate-500 -mt-0.5">Towing & Recovery</div>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            ...
            <a href="tel:9999999999" className="inline-flex items-center rounded-full bg-red-600 px-4 py-2 text-white font-medium hover:bg-red-700 transition">
              Call Us Now!
            </a>
          </nav>
